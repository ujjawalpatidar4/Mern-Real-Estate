...
return (
    <main>
            ...
            {error && (
                <p className='my-7 text-center text-red-700 text-2xl'>
            ...
            />
                ...
                <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
                  ...
                  {currentUser && currentUser._id !== listing.userRef && !showContact && (
                    <button onClick={() => setShowContact(true)} className='bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 p-3 cursor-pointer'>
                      Contact landlord
                    </button>
                  )}
